...
export default function PartiallyFillForm({
  isPartiallyFillFormOpen,
  handlePartiallyFillFormOpen,
}) {
  ...
  return (
    <>
      <Transition appear show={isPartiallyFillFormOpen} as={Fragment}>
        <Dialog
          as="div"
          className="relative z-10"
          onClose={handlePartiallyFillFormOpen}
        >
          <Transition.Child
            as={Fragment}
                    ...
                    <div className="max-w-xl mx-auto">
                              ...
                              <div className="flex flex-col gap-2 formMain">
                                ...
                                <div className="flex flex-col gap-3 mt-3">
                                  ...
                                  <button
                                    ...
                                    onClick={handlePartiallyFillFormOpen}
                                  >
                                    Close
                                  </button>
                                </div>
                      ...
                      {postUserLogin.isSuccess &&
                        postUserLogin?.data?.data?.data?.paymentStatus ===
                          'incomplete' && (
                          <div className="absolute top-0 left-0 flex flex-col items-center justify-center w-full h-full gap-3 p-5 mt-3 text-center text-red-600 bg-white">
                            <p>
