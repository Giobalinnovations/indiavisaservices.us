...
export default function Step5Update() {
  ...
  if (getAllStepsDataIsSuccess) {
    const { __v, _id, ...cleanedStep55Data } = getAllStepsData?.data?.step5Data;
              ...
              <div>
                ...
                <div className="flex items-start justify-start py-8 space-x-2">
                  ...
                  <p className="font-semibold">
                    ...
                    above is correct to the best of my knowledge and belief. In
                    case the information is found false at any stage, I am
