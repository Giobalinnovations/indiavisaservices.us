    ...
    <div className="">
          ...
          <div className="text-white h-full bg-gradient-to-r from-black/80 via-black/50 to-transparent">
            <div className="container p-0 ">
              <div className="space-y-4 flex flex-col h-[110vh]  justify-center w-[80%]">
                ...
                <p className="text-lg">
                  All foreign nationals entering India are required to possess a valid international travel document in the
                  form of a national passport with a valid visa from an Indian Mission/Post or eVisa (Limited Categories)
                  from Bureau of Immigration, Ministry of Home Affairs.
                </p>
      ...
      <div className="absolute bottom-0 bg-black/50 w-full">
        <div className="container flex items-center justify-between text-white py-4 overflow-x-auto flex-wrap gap-4">
          ...
          <div
            className="flex items-center space-x-4 md:text-base ">
            <marquee>Avail Indian Visa plus services through "Official app Indian Visa Su-Swagatam" mobile App for 60 countries".... One stop solution for all Visa related services.
            </marquee>
          </div>
