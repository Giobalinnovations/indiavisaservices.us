...
const Footer = () => {
  ...
  return (
    <div className=" ">
      <div
        className="pb-6 bg-cover bg-no-repeat bg-right-bottom"
        style={{
          ...
          <div className="pt-16">
                  ...
                  <ul className="">
                    <Link href="#">
                      <li className="text-base  hover:text-primary mt-2 flex space-x-2 items-center">
                        <IoIosMail className="rounded-full bg-white  p-1 w-6 h-6 text-black" />{" "}
                    ...
                    {/* <Link href="#">
                      <li className="text-base  hover:text-primary mt-2 flex space-x-2 items-center">
                        <FaPhoneAlt className="rounded-full bg-white  p-1 w-6 h-6 text-black" />{" "}
            ...
            <div className="text-center py-5 text-white text-base md:px-0 px-5">
              <p>
                {" "}
                Copyright © 2023 |
                <span className="font-semibold px-2">E-Visa</span>| All Rights
                Reserved
              </p>
            </div>
          </div>
