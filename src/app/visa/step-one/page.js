                                ...
                                <div className="px-4 py-2 space-y-2">
                                  ...
                                  QUALIFYING CERTIFICATE/ DIPLOMA ETC)`
                                    ...
                                    <label htmlFor="eTouristVisa30DaysValue4">
                                      ...
                                      OR STRUCTURED COURSE/PROGRAMME (COURSES
                                      NOT EXCEEDING 6 MONTHS DURATION AND NOT
                                      ISSUED WITH A QUALIFYING CERTIFICATE/
                                      DIPLOMA ETC)
                                    </label>
                                  </div>
                                  <div className="flex items-start space-x-2">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-start space-x-2">
                                    ...
                                    <label htmlFor="eConferenceVisaValue">
                                      ...
                                      THE GOVERNMENT OF INDIA,STATE GOVERNMENTS
                                      OR UT ADMINISTRATIONS AND THEIR
                                      SUBORDINATE/ ATTACHED ORGANIZATIONS AND
                                      PSUS
                                    </label>
                                  </div>
                                </div>
